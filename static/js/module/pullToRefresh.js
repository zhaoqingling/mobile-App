...
var refresher = {
									...
									parameter.id,\
									 {\
										...
										onScrollMove: function () {\
														     refresher.onScrolling(this,pullDownEle,pullUpEle,pullUpOffset,parameter.pullDownAction,parameter.pullUpAction);\
																		},\
	...
	onScrolling: function(e, pullDownEle, pullUpEle, pullUpOffset, pullDownAction, pullUpAction) {
		console.log(e)
		var dpr = $('html').attr('data-dpr') * 100;
		console.log(dpr)
		console.log(e.y)
		if( e.y > dpr ){
			// e.y = 0;
		...
		/*if(e.dirY ==1 && e.distY<=(e.maxScrollY-100)){
			e.y = e.maxScrollY;
		}*/
